...
<link  rel="stylesheet" href="css/bootstrap.min.css"/>
 ...
 <style>
  ...
  .onexe{
      ...
      transform: translateX(0);  /* Set the initial position */
      animation-name: none;
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/DEV.jpg" width=80 height=80 alt="Muhammad Yusuf" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Muhammad Yusuf</a>
